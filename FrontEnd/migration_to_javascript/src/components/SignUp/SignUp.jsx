    ...
    const handleSubmit = (e) => {
        ...
        postSignup(URL_SIGNUP, parsedUserInfo)
            .then(( data ) => {
                ...
                setNotice( (prev) => {
                    return {...prev, show:true, content:"Usuario registrado correctamente", type:"success"}
                } )
            })
            .catch(( error ) => {
                setNotice(prev => {
                    return {...prev, content:error.response.data.error, type:"error", show:true, showTime:5}
                })
            })
    }
            ...
            <div className="wrapper box-config">
                ...
                <form className='form_format' onSubmit={handleSubmit}>
                    ...
                    }
                    {
                        ...
                        <p className='error'>La contraseña debe tener al menos 6 carácteres.</p> :
                        null 
                    }
                    <button 
                        type="submit" 
                        className="btn-ing"> Registrarme 
                    </button>
                </form>
            </div>
        </>
